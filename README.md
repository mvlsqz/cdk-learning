...
npm run cdk-dev deploy # deploy the stack for the dev environment
npm run cdk-dev diff # compare the deployed stack with current state for dev environment
npm run cdk-dev destroy # destroy the stack for the dev environment
```
